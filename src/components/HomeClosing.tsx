...
export function HomeClosing({ locale }: HomeClosingProps) {
  return (
    <section className="section-padding-sm bg-nieve">
      <div className="container-page grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:gap-12 lg:items-start">
        <Reveal>
          <div>
            ...
            <Link href="/preguntas-frecuentes" className="mt-4 inline-block text-sm font-semibold text-hielo hover:text-accent">
        ...
        <Reveal delay={100}>
          <div className="rounded-2xl mesh-dark px-6 py-8 text-nieve sm:px-8 sm:py-10">
