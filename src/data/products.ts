...
export const products: Product[] = [
  {
    ...
    descriptionEs:
      "Actividad Full Day con 5 horas de clase efectivas y 1 hora de comodín. Horario ajustado a tus necesidades y punto de encuentro personalizado.",
    descriptionEn:
      "Full Day with 5 hours of effective lesson time and 1 hour buffer. Schedule tailored to your needs with a personalised meeting point.",
  ...
  },
  {
    ...
    descriptionEs:
      "Día completo para niños con clases dinámicas y divertidas. Formato de 5 horas de clase + 1 hora de comodín.",
    descriptionEn:
  ...
  },
  {
    ...
    category: "full-day",
    titleEs: "Día completo iniciación",
  ...
  },
  {
    ...
    descriptionEs:
      "Clases particulares de 1 a 8 participantes. Duración mínima 2 horas. El precio es el total del grupo y sube con cada persona. Elige horario y disciplina.",
    descriptionEn:
      "Private lessons for 1 to 8 participants. 2-hour minimum. The price is the group total and rises with each person. Choose schedule and discipline.",
    disciplines: ["esqui", "snowboard", "telemark", "esqui-adaptado"],
