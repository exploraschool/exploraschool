...
const legacyRedirects = [
  ...
  { source: "/reserva", destination: "/clases", permanent: true },
  { source: "/reserva-clases", destination: "/clases", permanent: true },
  { source: "/equipo-explora", destination: "/equipo", permanent: true },
  ...
  { source: "/clases/freeride-freestyle", destination: "/clases/freeride", permanent: true },
  ...blogSlugs.map((slug) => ({
    source: `/${slug}`,
